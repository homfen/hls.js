...
const HlsEvents = {
  ...
  // hook, fired before real start loading - data: { frag : fragent object}
  FRAG_LOADING_INIT: "hlsFragLoadingInit",
  // fired before real start loading - data: { frag : fragent object}
  FRAG_LOADING_INITED: "hlsFragLoadingInited",
